...
class Day10Test {
  ...
  fun `part 1 sample input - machine 1`() {
    part1.solve("[.##.] (3) (1,3) (2) (2,3) (0,2) (0,1) {3,5,4,7}").shouldBe(2L)
  }

  @Test
  fun `part 1 sample input - machine 2`() {
    part1.solve("[...#.] (0,2,3,4) (2,3) (0,4) (0,1,2) (1,2,3,4) {7,5,12,7,2}").shouldBe(3L)
  }

  @Test
  fun `part 1 sample input - machine 3`() {
    part1.solve("[.###.#] (0,1,2,3,4) (0,3,4) (0,1,2,4,5) (1,2) {10,11,11,5,10,5}").shouldBe(2L)
  }

  @Test
  fun `part 1 sample input`() {
    val input = readInputText("day10-sample.txt")
    part1.solve(input).shouldBe(7L)
  }

  @Test
  fun `part 1 input`() {
    val input = readInputText("day10-input.txt")
    part1.solve(input).shouldBe(469L)
  }
